  ...
  <div>
    <div class="flex">
      <div class="flex align-items-center mt-0 col-6">
        <h5 class="p-title m-2 p-2 mb-0 mt-0 font-semibold">DANH MỤC TIỀN TỆ</h5>
      </div>
    </div>
  </div>
  <!-- End Header -->
      ...
      <div class="card p-0">
        <div class="panel-content" style="position: relative">
          ...
          >
            ...
            <Column header="Trạng thái" headerStyle="width:25%; min-width:8rem;text-al">
              <template #body="slotProps">
                {{ slotProps.data.IsActive == "A" ? "Hoạt Động" : "Không Hoạt Động" }}
              </template>
            </Column>
            <Column headerStyle="min-width:10rem;" header="Hành động">
              <template #body="slotProps">
                <Button
                  icon="pi pi-pencil"
    ...
    <div class="grid">
      <div class="field col-6">
        ...
        <small class="p-invalid" v-if="submitted && !dataEdit.FobName"
          >Không được bỏ trống mã tiền tệ.</small
        >
      </div>
      <div class="field col-6">
        ...
        <small class="p-invalid" v-if="submitted && !dataEdit.FobDesc"
          >Không được bỏ trống tên tiền tệ.</small
        >
      </div>
...
//-------------------- Start CRUD ------------------
const header_update = ref("SỬA HÌNH TIỀN TỆ");
const header_new = ref("THÊM MỚI HÌNH TIỀN TỆ");
