<template>
  <div>
    <div class="flex">
      <div class="flex align-items-center mt-0 col-6">
        <h5 class="p-title m-2 p-2 mb-0 mt-0 font-semibold">BÁO CÁO GÓI THẦU</h5>
      </div>
    </div>
  </div>
  <!-- End Header -->
      ...
      <div class="card p-0">
        <div class="panel-content" style="position: relative">
          ...
          >
            ...
            <Column field="FobName" header="Mã hàng hoá"> </Column>
            <Column field="FobDesc" header="Tên hàng hoá"> </Column>
            <Column field="FobDesc" header="Nhà cung cấp"> </Column>
            <Column field="FobDesc" header="Số lượng"> </Column>
            <Column field="IsActive" header="Số tiền mua"> </Column>
            <Column headerStyle="width:10rem;" header="Hành động" :sortable="false">
            </Column>
          </DataTable>
        </div>
  ...
  >
    <div class="card">
      <TabView>
        <TabPanel header="Hàng hoá">
          <div>
            <div>
              <h6 class="bold font-bold">Thời gian</h6>
              <div class="grid">
                <div class="col-3">
                  <div class="flex align-items-center">
                    <RadioButton
                      ...
                      value="Cheese"
                    />
                    <label for="ingredient1" class="ml-2"> Báo cáo hàng năm </label>
                  </div>
                </div>
                <div class="col-3">
                  <div class="flex align-items-center">
                    <RadioButton
                      ...
                      value="Cheese"
                    />
                    <label for="ingredient1" class="ml-2"> Báo cáo hàng quý </label>
                  </div>
                </div>
                <div class="col-3">
                  <div class="flex align-items-center">
                    ...
                    />
                    <label for="ingredient1" class="ml-2"> Báo cáo hàng tháng </label>
                  </div>
                </div>
                <div class="col-3">
                  <div class="flex align-items-center">
                    <RadioButton
                      ...
                      value="Cheese"
                    />
                    <label for="ingredient1" class="ml-2"> Tuỳ chọn </label>
                  </div>
                </div>
              </div>
              <hr />
            ...
            <div>
              <h6 class="bold font-bold">Loại hiển thị</h6>
              <div class="grid">
                <div class="col-3">
                  <div class="flex align-items-center">
                    <RadioButton
                      ...
                      value="Cheese"
                    />
                    <label for="ingredient1" class="ml-2">Theo sản phẩm </label>
                  </div>
                </div>
                <div class="col-3">
                  <div class="flex align-items-center">
                    <RadioButton
                      ...
                      value="Cheese"
                    />
                    <label for="ingredient1" class="ml-2"> Theo nhóm sản phẩm </label>
                  </div>
                </div>
              </div>
              <hr />
            ...
            <div>
              <h6 class="bold font-bold">Lựa chọn sản phẩm</h6>
              <div class="grid">
                <div class="col-6">
                  <div class="field">
        ...
        <TabPanel header="Nhà cung cấp">
          <div>
                ...
                <div class="col-3">
                  <div class="flex align-items-center">
                    <RadioButton
                      ...
                      value="Cheese"
                    />
                    <label for="ingredient1" class="ml-2">Theo nhà cung cấp </label>
                  </div>
                </div>
                <div class="col-9">
                  <div class="flex align-items-center">
                    <RadioButton
                      ...
                      value="Cheese"
                    />
                    <label for="ingredient1" class="ml-2">Theo nhóm nhà cung cấp </label>
                  </div>
                </div>
              </div>
              <hr />
            ...
            <div>
              <h6 class="bold font-bold">Lựa chọn nhà cung cấp</h6>
              <div class="grid">
                <div class="col-6">
                  <div class="field">
