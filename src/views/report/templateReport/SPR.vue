    ...
    <div class="grid align-items-center justify-content-between">
      <div class="col-6 flex align-items-center">
        ...
        <h4 class="m-0 p-title m-2 p-2 mb-0 mt-0 font-semibold">
          BÁO CÁO TỔNG HỢP YÊU CẦU MUA SẮM
        </h4>
      </div>
      <div class="col-6">
    ...
    <div class="grid">
      <div class="card mt-5 col-12">
        <div class="text-center mt-5">
          <h5 class="font-semibold">BÁO CÁO TỔNG HỢP YÊU CẦU MUA SẮM</h5>
        ...
        <div class="mt-5 p-3">
          <div>
            <DataTable ref="dt" :value="data" tableStyle="min-width: 50rem" showGridlines>
              ...
              <Column field="month_1" header="Tháng 1" style="text-align: right"></Column>
              <Column field="month_2" header="Tháng 2" style="text-align: right"></Column>
              <Column field="month_3" header="Tháng 3" style="text-align: right"></Column>
              <Column field="month_4" header="Tháng 4" style="text-align: right"></Column>
              <Column field="month_5" header="Tháng 5" style="text-align: right"></Column>
              <Column field="month_6" header="Tháng 6" style="text-align: right"></Column>
              <Column field="month_7" header="Tháng 7" style="text-align: right"></Column>
              <Column field="month_8" header="Tháng 8" style="text-align: right"></Column>
              <Column field="month_9" header="Tháng 9" style="text-align: right"></Column>
              <Column
                field="month_10"
                header="Tháng 10"
